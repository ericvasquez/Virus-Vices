const newGame = new CardsAgainstHumanity();
const players = new Players();
const clicked = new Audio();
const selectedCard = new Audio();
...
$(document).ready(function () {
  ...
  $(
    "body .welcome .welcome-wrapper #title, #subtitle, #instructions, #start-wrapper"
  ).hide();
  ...
  for (let i = 0; i < players.player1.length; i++) {
    // console.log(i);
    const p = $("<p></p>");
  ...
  $("body").on("click", ".player-one .select-button", function () {
    clicked.play();
    switchDivOne = $(this)
      .closest(".player-one > .player-white")
      .addClass("player-one-czar")
      .remove();
  ...
  $("body").on("click", ".player-two .select-button", function () {
    clicked.play();
    switchDivTwo = $(this)
      .closest(".player-two > .player-white-2")
      .addClass("player-two-czar")
      .remove();
  ...
  $("body").on(
    "click",
    ".card-czar .player-one-czar .select-button",
    function () {
      selectedCard.play();
  ...
  $("body").on(
    "click",
    ".card-czar .player-two-czar .select-button",
    function () {
      selectedCard.play();
  ...
  $("body").on("click", "#new-game", function () {
    ...
    clicked.play();
    $(".win-img").remove();
    const newDecks = newGame.shuffleDeck();
