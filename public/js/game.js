...
function CardsAgainstHumanity() {
  this.blackCards = [
    ...
    "_____________.  That's how I want to die.",
    ...
    "Donald Trump's _______ are so good.  They're the best, folks.",
    "America is really good at __________.",
  ];
